...
# train_list, output_list = readlist(FLAGS.train, FLAGS.output)
# mkdir(FLAGS.train, FLAGS.output_train)
# img2vec(train_list, output_list)
filepath = []
file_list = getfilelist('E:\PROJECT\Fisher_loss\\feature\\footnet_v8_256_metric_v4\img', filepath)
print(file_list)
